...
//     src: projectOne,
//     githubLink: "https://github.com/piyamantha93/Stress_Detection", // GitHub link is passed here
...
//   return (
//     <section id="projects" className="bg-gray-200 w-full py-20 border-b-[1px]">
